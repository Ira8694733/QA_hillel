...
console.log(isValidString("Anna Karenina"));  // false
console.log(isValidString("Ukraine"));   // true
...
*/
let text = 'cat car can';
let regex = /\b(cat|can)\b/g;

console.log(text.match(regex)); // "cat", "can"
...
let textCups = 'I would like 8 cups of coffee, please.'
let regexCountCups = /\b\d+\b/g;

console.log(textCups.match(regexCountCups)); // 8
...
let textWordH = 'Hello people of 1974. I come from the future. In 2014 we have laser guns, hover boards and live on the moon!';
let regexFindH = /\bh\w*\b/gi;

console.log(textWordH .match(regexFindH)); // 'Hello', 'have', 'hover' 
